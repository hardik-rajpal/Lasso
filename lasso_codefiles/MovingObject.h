...
//the boolean parameter in reset_all tells the function if we want to randomize the objects x-position or not.
  void reset_all(double &argx, double &argy, double speed, double angle_deg, bool argpaused, bool rtheta, bool randomize_position);
  ...
  //hideObj hides all parts of the object.
  void hideObj();
  //showObj shows all parts of the project.
  void showObj();
  //nextstep moves the object with time, the argument is the time interval.
  void nextStep(double t);
  //attaches one object to another.
